...
source: "https://docs.unsloth.ai/basics/reinforcement-learning-rl-guide"
...
> 该页面详细介绍了强化学习（RL）及其相关概念（如RLVR、PPO、GRPO、RLHF、RFT），并探讨了“运气就是一切”是否适用于RL。文章从基础概念（如环境、代理、动作、奖励函数）到高级技术（如GRPO的优势和实现）进行了全面讲解。此外，还提供了使用Unsloth进行GRPO训练的教程链接、GPU VRAM需求指南以及奖励函数的设计示例。目标是帮助读者理解如何通过RL优化模型输出，并提供了实用工具和资源链接。
...
3. In RL, you can't know the "best action" you can take, but you can observe intermediate steps, or the final game state (win or lose)

![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/df0419cf8773f7b35cf726b000df3c70_MD5.jpg]]![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/1c1c4e744f4c689449bf4ded24f9bd5c_MD5.jpg]]
...
![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/26d2137354e3e361722a68177bf8c740_MD5.jpg]]
...
![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/d55c9f07525b849386693cd374a4884d_MD5.jpg]]

![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/f978105539b7fdfccffbdf3652829a20_MD5.jpg]]
...
![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/e68d3f3fc4765f3855e32b83fbd839c3_MD5.jpg]]
...
![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/3e8f992621c772de1165e0088a58d323_MD5.jpg]]
...
![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/462c32ec079747810b34fe02a302fae7_MD5.jpg]]
...
![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/2f166182028bb30229a9e728a2f80155_MD5.jpg]]
...
- On [**20K context lengths**](https://docs.unsloth.ai/basics/reinforcement-learning-rl-guide#grpo-requirement-guidelines) for example with 8 generations per prompt, Unsloth uses only 54.3GB of VRAM for Llama 3.1 (8B), whilst standard implementations (+ Flash Attention 2) take **510.8GB (90% less for Unsloth)**.
...
![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/7081e77e331834fc6ef67e2bccd07a00_MD5.jpg]]
...
1. Each response is evaluated using reward functions.
2. Training Steps:
	- If you have 300 rows of data, that's 300 training steps (or 900 steps if trained for 3 epochs).
3. The model learns by updating its weights every step.

If you're having issues with your GRPO model not learning, we'd highly recommend to use our [Advanced GRPO notebooks](https://docs.unsloth.ai/get-started/unsloth-notebooks#grpo-reasoning-notebooks) as it has a much better reward function and you should see results much faster and frequently.
...
- The more you train with GRPO the better. The best part of GRPO is you don't even need that much data. All you need is a great reward function/verifier and the more time spent training, the better your model will get. Expect your reward vs step to increase as time progresses like this:
	![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/2cb5a8c68e24c979dc63d003b58f6b64_MD5.jpg]]
...
![[images/Reinforcement Learning (RL) Guide  Unsloth Documentation/b781a4a9e6cc02abf6a924e7783aa0cd_MD5.jpg]]
...
![[/images/Reinforcement Learning (RL) Guide  Unsloth Documentation-1754281822500.webp]]
...
[Previous DeepSeek-R1-0528: How to Run Locally](https://docs.unsloth.ai/basics/deepseek-r1-0528-how-to-run-locally) [Next Tutorial: Train your own Reasoning model with GRPO](https://docs.unsloth.ai/basics/reinforcement-learning-rl-guide/tutorial-train-your-own-reasoning-model-with-grpo)
